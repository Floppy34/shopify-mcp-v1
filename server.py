...
async def shopify_create_page(params: CreatePageInput) -> str:
    ...
    try:
        ...
        result = await _request("POST", "/pages.json", body=payload)
        return _fmt(result)
    except Exception as e:
        return _fmt({"error": str(e)})
...
class UpdatePageInput(BaseModel):
    ...
    template_suffix: Optional[str] = None  # e.g. "listicle" pour page.listicle.liquid
...
async def shopify_update_page(params: UpdatePageInput) -> str:
    ...
    try:
        ...
        if params.template_suffix is not None:
            payload["page"]["template_suffix"] = params.template_suffix
        result = await _request("PUT", f"/pages/{params.page_id}.json", body=payload)
        return _fmt(result)
    except Exception as e:
        return _fmt({"error": str(e)})
...
async def shopify_create_theme_asset(params: CreateThemeAssetInput) -> str:
    ...
    try:
        ...
        result = await _request("PUT", f"/themes/{params.theme_id}/assets.json", body=payload)
        return _fmt(result)
    except Exception as e:
        return _fmt({"error": str(e)})
